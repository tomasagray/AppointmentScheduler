...
//    private TextField appointmentType;
    ...
    /**
     * Extract data from the modal dialog and store it in the 
     * Appointment instance variable.
     * 
     */
    ...
    /**
     * Resets the modal. Returns all text fields to blank ("")
     * and clears the selection of all combo boxes.
     */
    @Override
    public void reset()
    {
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        // ---------------------------------------------------------------------
        appointmentStart.setCellFactory((combobox) -> {
        ...
        appointmentEnd.setCellFactory((combobox) -> {
           return new ListCell<Integer>() 
           {
               @Override
               protected void updateItem(Integer item, boolean empty)
        ...
        customerNames.setCellFactory((combobox) -> {
